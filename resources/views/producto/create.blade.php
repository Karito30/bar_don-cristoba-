    ...
    @section('contenedor')
        ...
        <form action="{{ route('producto.store') }}" method="POST">
            ...
            <div>
                ...
                <input type="text" class="form-control @error('NOM_PRODUCTO') is-invalid @enderror" name="NOM_PRODUCTO" id="NOM_PRODUCTO" maxlength="50" pattern="[A-Za-z ]+" title="Solo letras y espacios permitidos">
            ...
            <div>
                ...
                <input type="number" class="form-control @error('VALOR_PRODUCTO') is-invalid @enderror" name="VALOR_PRODUCTO" id="VALOR_PRODUCTO" maxlength="50" pattern="[0-9]+" title="Solo se permiten números">
                <div class="invalid-feedback">
            ...
            <div>
                ...
                <select class="form-select @error('CATEGORIA_PRODUCTO') is-invalid @enderror" name="CATEGORIA_PRODUCTO" id="CATEGORIA_PRODUCTO">
            ...
            <div>
                ...
                <input type="number" class="form-control @error('CANT_PRODUCTO') is-invalid @enderror" name="CANT_PRODUCTO" id="CANT_PRODUCTO" maxlength="2" pattern="[0-9]+" title="Solo se permiten números">
                <div class="invalid-feedback">
                    @error('CANT_PRODUCTO')
                        {{ $message }}
                    @enderror
            ...
            <div>
                <label for="ID_PROVEEDOR_FK_PRODUCTO" class="form-label">PROVEEDOR</label>
