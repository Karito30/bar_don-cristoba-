...
<body>
  ...
  @section('contenedor')
  <h1 style="color: #fff;">GESTION INVENTARIO</h1>
...
@endif
    ...
    <form action="excel_producto" enctype="multipart/form-data" class="btn-group">
        <button class="btn btn-success">Excel</button>
</form>
<form action="{{ route('producto.pdf')}}" enctype="multipart/form-data" class="btn-group">
            ...
            @foreach ($productos as $producto)
                <tr>
                    ...
                    <td class="btn-group">
                        ...
                        <a href="{{ route('producto.edit',$producto->ID_PRODUCTO) }}" class="btn btn-warning">Actualizar</a>
